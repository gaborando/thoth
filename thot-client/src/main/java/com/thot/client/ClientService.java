...
public class ClientService {
    ...
    public ClientService(@Value("${thot.out.dir}") String outDir,
                         @Value("${thot.svgexport.executable}") String executable,
                         RabbitTemplate rabbitTemplate,
                         @Value("${thot.client.name}") String clientName,
                         @Value("${thot.client.identifier}") String clientIdentifier,
                         @Value("${thot.server.exchange}") String serverExchange) {
    ...
    @RabbitListener(queues = "thot.${thot.client.identifier}.rpc.requests")
